...
int main() {
    ...
    Instance instance =
        make_instance_quebec(1, 0, median, 0,
                             Point(240548, 4986893), Point(64000, 40000));
...
//     std::vector<double> median_dists{2000, 2500, 3000, 4000, 5000, 6000};
...
//             std::cout << lemon::countNodes(landscape.getNetwork()) <<
//             std::endl;

//             Helper::assert_well_formed(landscape, plan);
//             Helper::printInstanceGraphviz(landscape, plan, "quebec.dot");

//             auto restored_landscape = Helper::decore_landscape(landscape,
//             plan);
