...
Instance2 parse_instance2(std::filesystem::path instance_path) {
    ...
    assert_json_properties(instance_json,
                           {{"options", nlohmann::detail::value_t::object},
                            {"cases", nlohmann::detail::value_t::array}});
    auto options_json = instance_json["options"];
    assert_json_properties(options_json,
                           {{"file", nlohmann::detail::value_t::string}});

    {
        ...
        configure_csv_reader(options_csv, options_json, "option_id", "option_cost");
    ...
    for(auto case_json : instance_json["cases"]) {
        assert_json_properties(case_json,
                               {{"name", nlohmann::detail::value_t::string},
        ...
        configure_csv_reader(nodes_csv, nodes_json, "node_id", "node_quality");
        ...
        configure_csv_reader(arcs_csv, arcs_json, "arc_id", "arc_probability");
