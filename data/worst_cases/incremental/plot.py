...
rows = readCSV('/home/plaiseek/Projects/landscape_opt_cpp/data/worst_cases/incremental/data.log')
...
plt.savefig("data/worst_cases/incremental/inc worst case-opt ratio vs budget.pdf", dpi=500)